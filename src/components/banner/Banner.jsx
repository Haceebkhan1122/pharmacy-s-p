...
import banner01 from "../../assets/images/png/banner0111.png"
import banner02 from "../../assets/images/png/banner0222.png"
import banner03 from "../../assets/images/png/banner0333.png"


import banner01Mobile from "../../assets/images/png/mobBanner1.png"
import banner02Mobile from "../../assets/images/png/mobBanner2.png"
import banner03Mobile from "../../assets/images/png/mobBanner3.png"


import responsiveBanner from "../../assets/images/png/resBanner01.jpg"
...
function Banner({ data }) {
  ...
  const slides = [
    {
      src: banner01?.src ?? banner01,
      mobileImage: banner01Mobile?.src ?? banner01Mobile,
      heading: "Take control of your diabetes",
    },
    {
      src: banner02?.src ?? banner02,
      mobileImage: banner02Mobile?.src ?? banner02Mobile,
      heading: "Lose weight, gain health",
    },
    {
      src: banner03?.src ?? banner03,
      mobileImage: banner03Mobile?.src ?? banner03Mobile,
      heading: "Whole-body protection made simple",
    },
  ];
  ...
  return (
    <>
    <div className={slides[1]?.src == active?.src ? `${styles.mainWrapperBanner} ${styles.secondImage}` : styles.mainWrapperBanner}>
      <Container fluid className="h-100 p-0">
        <Col lg={12}> 
          <Row className="h-100">
            <Col lg={6} md={6} className={styles.image_col_main}>
              <div style={{ transition: "all 0.6s ease-in-out" }} className={styles.wrape_image_banner}>
                <Image layout="fill" src={isMobile ? active.mobileImage : isTablet ? active?.src : active?.src} alt="" />
              </div>
            </Col>
            <Col lg={6} className="ms-0" sm={6} md={6} xs={12} >
            <div className={styles.wrape_infoo}>
              <div></div>
              <h2 className={slides[1]?.src == active?.src ? styles.headingBlack : styles.headingMainBanner} >{active?.heading || ''} </h2>
              <div className={styles.box_banner_bottom}>
                <p className={`${styles.zind} ${styles.banner_description}`}>
                  {data?.HomePage?.banner_description}
                </p>
                <div className={`${styles.btnUrdu} d-flex gap-3`}>
                  <button className={styles.button1} onClick={() => window.open("https://wa.me/9221111455455", "_blank")}>
                    ...
                    {data?.HomePage?.need_consult_btn}
                  </button>
                </div>
                <a className={styles.numBannnerr} href="tel:021-111-455-455"> Call us at <span> 111-455-455 </span> </a>
                </div>
              </div>
            </Col>
          </Row>
