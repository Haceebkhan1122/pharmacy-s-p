...
import SempHeroImage from "../../assets/images/png/sempRightSide.png";
                ...
                <Col lg={6} sm={6} md={6} className={`${styles.cardContainerSemP} my-auto`}>
                  ...
                  <article className={styles.cardSemP}>
                    <p className={styles.cardTitleSemP}>
                      {parse(data.HomePage.hero_heading)}
                    </p>
                    <p className={styles.cardDescriptionSemP}>
                      {data?.HomePage?.hero_description}<br /><br />
                      {data?.HomePage?.hero_description_two}
                    </p>
                    {/* <ul className={styles.listDescriptionSemP}>
                      <li>{data?.HomePage?.hero_list_description1}</li>
                      <li>{data?.HomePage?.hero_list_description2}</li>
                    </ul> */}
                  </article>
                </Col>
